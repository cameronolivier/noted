...
import { relations, lower, sql } from 'drizzle-orm' // Added sql for default functions like now()
...
export const tags = createTable(
  ...
  (t) => ({
    ...
    uniquePerUser: uniqueIndex('tags_user_name_idx').on(lower(t.name), t.userId),
  })
)
